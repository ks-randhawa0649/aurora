...
function IntroSection( props ) {
    return (
        <>
            <section className="intro-section" style={{ margin: 0, padding: 0 }}>
                {/* Main Hero Slide */}
                <div className="banner banner-fixed intro-slide1" style={{ minHeight: '100vh', height: '100vh', marginTop: 0 }}>
                    <figure className="hero-figure" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
                        <LazyLoadImage
                    ...
                    <div className="container intro-slide1-container">
                        <div className="banner-content intro-slide1-content y-50">
            ...
            <style jsx>{`
                ...
                @media (max-width: 767px) {
                    ...
                    /* Remove ALL spacing from parent wrappers */
                    .page-content {
                    ...
                    /* NUCLEAR OPTION - Force slide 1 to fill screen */
                    .intro-slide1,
                    .intro-slide1.banner,
                    .intro-slide1.banner-fixed {
                    ...
                    .intro-slide1 .hero-figure,
                    .intro-slide1 > .hero-figure,
                    .intro-slide1 > figure.hero-figure {
                    ...
                    .intro-slide1 .hero-figure img,
                    .intro-slide1 .hero-figure .lazy-load-image-background,
                    .intro-slide1 .hero-figure .lazy-load-image-background img {
                        width: 100% !important;
                    ...
                    .intro-slide1 .badge-label {
                        margin-top: 0 !important;
                        padding-top: 0 !important;
                    }
                    
                    .intro-slide1 .y-50,
                    .intro-slide1 .banner-content.y-50 {
                        top: auto !important;
                        transform: none !important;
                    }
                    ...
                    .intro-slide1 .hero-title {
                        font-size: 36px !important;
                        margin-bottom: 12px;
                    }
                    
                    .intro-slide1 .hero-description {
                        font-size: 15px !important;
                        margin-bottom: 24px;
                    }
                    
                    .intro-slide1 .btn-modern {
                        padding: 14px 28px;
                        font-size: 14px;
                    }
                    
                    /* Hide slide 2 (harmehak) on mobile */
                    .intro-slide2 {
                        position: relative !important;
                        min-height: 100vh !important;
                    }
                    
                    .intro-slide2 .split-layout {
                        position: relative !important;
                        min-height: 100vh !important;
                    }
                    
                    .intro-slide2 .image-side {
                        position: absolute !important;
                        top: 0 !important;
                        left: 0 !important;
                        width: 100% !important;
                    ...
                    .intro-slide2 .image-side .model-figure img {
                        width: 100% !important;
                        height: 100% !important;
                        max-height: none !important;
                        object-fit: cover !important;
